  ...
  <body class="bg-white text-gray-800">
    ...
    <header class="bg-white shadow fixed w-full z-50">
      <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-gray-900">Disambiphotoworks</h1>
        <nav class="space-x-6">
          <a href="#about" class="hover:text-green-600 text-gray-800">Tentang</a>
          <a href="#services" class="hover:text-green-600 text-gray-800">Layanan</a>
          <a href="#testimoni" class="hover:text-green-600 text-gray-800">Testimoni</a>
