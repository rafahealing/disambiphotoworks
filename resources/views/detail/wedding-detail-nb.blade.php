...
<body class="bg-white text-gray-800">
  ...
  <section class="relative overflow-hidden">
    <div class="max-w-screen-md mx-auto px-4 py-10">
      <div class="h-[250px] overflow-hidden rounded-xl shadow-lg">
        <img src="{{ asset('images/NB/wedding(N,B).jpg') }}" alt="Kak N & Kak B"
          class="w-full h-full object-cover object-center">
      </div>
      <div class="text-center mt-6">
        <h1 class="text-3xl md:text-4xl font-bold mb-2">Kak N & Kak B</h1>
  ...
  <section class="py-12 px-6 max-w-3xl mx-auto text-center">
    ...
    <p class="text-gray-700 text-lg leading-relaxed">
      Sebuah hari yang penuh cinta dan kebahagiaan di tengah keluarga dan teman-teman terdekat. Dengan latar belakang alam yang menawan dan suasana hangat, momen ini menjadi kenangan yang tak terlupakan bagi Kak N & Kak B.
    </p>
  </section>
    ...
    <div class="relative">
      ...
      <div id="carousel" class="flex gap-4 snap-x snap-mandatory overflow-x-auto scroll-smooth pb-4 px-10">
        <div class="flex-shrink-0 w-80 snap-start">
          <img src="{{ asset('images/NB/wedding(N,B1).jpg') }}" alt="Foto Tambahan 1" class="rounded-lg shadow-lg object-cover w-full aspect-[4/3]">
        </div>
        <div class="flex-shrink-0 w-80 snap-start">
          <img src="{{ asset('images/NB/wedding(N,B2).jpg') }}" alt="Foto Tambahan 2" class="rounded-lg shadow-lg object-cover w-full aspect-[4/3]">
        </div>
